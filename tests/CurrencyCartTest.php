...
class CurrencyCartTest extends PHPUnit_Framework_TestCase {
	...
	public function test_cart_sub_total() {
		...
		$this->assertEquals(11950, $this->cart->subTotal()->amount(), 'Cart should have sub total of 1195');
	}
	...
	public function test_sub_total_when_item_quantity_is_updated() {
		...
		$this->assertEquals(27322, $this->cart->subTotal()->amount(), 'Cart should have sub total of 27322');

		// when cart's item quantity is updated, the subtotal should be updated as well
		$this->cart->update(456, array('quantity' => 2));

		$this->assertEquals(40920, $this->cart->subTotal()->amount(), 'Cart should have sub total of 4092');
	}
	...
	public function test_sub_total_when_item_quantity_is_updated_by_reduced() {
		...
		$this->assertEquals(20523, $this->cart->subTotal()->amount(), 'Cart should have sub total of 20523');
	}
