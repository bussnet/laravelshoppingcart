...
class CurrencyCartConditionTest extends PHPUnit_Framework_TestCase {
	...
	public function test_total_without_condition() {
		...
		$this->assertEquals(18749, $this->cart->total()->amount(), 'Cart should have a total of 18749');
	}
	...
	public function test_total_with_multiple_conditions_added_scenario_one() {
		...
		// total should be changed
		$this->assertEquals(22593, $this->cart->total()->amount(), 'Cart should have a total of 22593');
	}
	...
	public function test_total_with_multiple_conditions_added_scenario_two() {
		...
		// total should be changed
		$this->assertEquals(19593, $this->cart->total()->amount(), 'Cart should have a total of 19593');
	}
	...
	public function test_total_with_multiple_conditions_added_scenario_three() {
		...
		// total should be changed
		$this->assertEquals(14905, $this->cart->total()->amount(), 'Cart should have a total of 14905');
	}
	...
	public function test_total_with_multiple_conditions_added_scenario_four() {
		...
		// total should be changed
		$this->assertEquals(17905, $this->cart->total()->amount(), 'Cart should have a total of 17905');
	}
	...
	public function test_add_item_with_condition() {
		...
		$this->assertEquals(95, $this->cart->get(456)->priceSumWithConditions()->amount());
		$this->assertEquals(95, $this->cart->subTotal()->amount());
	}
	...
	public function test_add_item_with_multiple_item_conditions_in_multiple_condition_instance() {
		...
		$this->assertEquals(8000, $this->cart->get(456)->priceSumWithConditions()->amount(), 'Item subtotal with 1 item should be 80');
		$this->assertEquals(8000, $this->cart->subTotal()->amount(), 'Cart subtotal with 1 item should be 80');
	}
	...
	public function test_add_item_with_multiple_item_conditions_with_one_condition_wrong_target() {
		...
		$this->assertEquals(8500, $this->cart->get(456)->priceSumWithConditions()->amount(), 'Cart subtotal with 1 item should be 85');
		$this->assertEquals(8500, $this->cart->subTotal()->amount(), 'Cart subtotal with 1 item should be 85');
	}
	...
	public function test_add_item_condition_restrict_negative_price() {
		...
		$this->assertEquals(0, $this->cart->get($item['id'])->priceSumWithConditions()->amount(), "The item's price should be prevented from going below zero.");
	}
